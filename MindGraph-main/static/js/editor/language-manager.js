    ...
    constructor() {
        ...
        this.translations = {
            en: {
                ...
                llmHunyuan: 'Hunyuan',
                llmHunyuanTooltip: 'Hunyuan/混元 (Tencent Cloud)',
                llmDoubao: 'Doubao',
                llmDoubaoTooltip: 'Doubao/豆包 (Volcengine)',
            ...
            zh: {
                ...
                empty: '清空',
                clear: '清空',
                clearCanvasTooltip: '清空画布上的所有内容',
                confirmClearCanvas: '确定要清空画布吗？此操作无法撤销。',
                undo: '撤销',
                redo: '重做',
                edit: '编辑',
                addFocus: '添加焦点',
                addFocusTooltip: '添加焦点问题',
                addNode: '添加节点',
                noFocusQuestion: '当前暂无焦点问题，请先添加一个焦点问题。',
                nodeCount: '节点',
                editMode: '编辑模式：激活',
                resetView: '重置视图',
                ...
                llmHunyuan: '混元',
                llmHunyuanTooltip: '混元（腾讯云）',
                llmDoubao: '豆包',
                llmDoubaoTooltip: '豆包（火山引擎）',
            ...
            az: {
                ...
                empty: 'Boşalt',
                clear: 'Təmizlə',
                clearCanvasTooltip: 'Kətandan bütün məzmunu silin',
                confirmClearCanvas: 'Kətanı təmizləmək istədiyinizə əminsiniz? Bu əməliyyat geri qaytarıla bilməz.',
                undo: 'Geri Al',
                redo: 'Təkrar',
                nodeCount: 'Düyünlər',
