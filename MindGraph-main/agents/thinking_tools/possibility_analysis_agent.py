...
Generates possibility analysis diagrams using mind map structure.
...
class PossibilityAnalysisAgent(MindMapAgent):
    ...
    def get_prompt(self, language='en'):
        ...
        return THINKING_TOOLS_PROMPTS.get(prompt_key, THINKING_TOOLS_PROMPTS['possibility_analysis_generation_en'])
